...
public:
    ...
    bool tryGetUIntByKey(unsigned int* out, const char* key) const;
    ...
    bool tryGetUInt64ByKey(unsigned long* out, const char* key) const;
    ...
    bool tryGetUIntByIndex(unsigned int* out, int index) const;
    bool tryGetFloatByIndex(float* out, int index) const;
    bool tryGetInt64ByIndex(long* out, int index) const;
    bool tryGetUInt64ByIndex(unsigned long* out, int index) const;
    bool tryGetDoubleByIndex(double* out, int index) const;
